                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group bootstrap-timepicker">
                                <label>Time Claim</label>
                                <input type="text" class="form-control timepicker field_disable" id="time_claim" name="time_claim" placeholder="" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
    ...
    function show_data(id){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $('#time_claim').val(data.time_claim);
