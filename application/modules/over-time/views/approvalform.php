            ...
            <div class="box-header box-header-main" style="padding-bottom:0px;">
                <h3 class="box-title">
                    <div class="col-lg-12 no-padding">
                        ...
                        <?php if($this->auth->hasPrivilege("DeleteOvertimeControl")){?><button type="submit" class="btn btn-success btn-flat btn-sm pull-right form-input-btn-active form-hide animated" style="margin-right: 10px;"><i class="fa fa-fw fa-check"></i> Active</button><?php }?>
                    ...
                    <fieldset>
                        <div class="row">
                            <div class="col-lg-10">
                                <div class="form-group">
                                    <label>Assigment To</label>
                                    <select class="input_select form-control field_disable" id="id_user" name="id_user">
                ...
                <table id="<? echo $table_id?>" class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th width="54%">Employee/Assigment</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#<? echo $form_id?> .form-input-data #date_assigment').change(function(){
            $('#<? echo $form_id?> .form-input-data').data('bootstrapValidator').revalidateField('date_assigment');
        })
    ...
    function show_data(id){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if (data.create_by_me == 'false') {
                    if (data.approve_status1!='0') {
                        $('.field_disable1').attr('disabled','disabled').trigger('chosen:updated');
                    }
                    else{
                        $('#approve_status1').removeAttr('disabled').trigger('chosen:updated');
                    }
                }
                else{
                    if (data.approve_status1!='0') {
                ...
                if (data.actual_start!='' && data.actual_end!='') {
                    $('#approve_status2').removeAttr('disabled').trigger('chosen:updated');
                }
