        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="small-box bg-aqua">
                    <div class="inner">
                        <h3 id="countLeave" style="margin-bottom: 0px;">00/00</h3>
                        <p style="margin-bottom: 0px;">Time Off Request <? echo date("Y");?></p>
                        <p id="interval_date" style="margin-bottom: 0px; font-size: 14px;">00:00</p>
                    </div>
                    <div class="icon">
    ...
    function getCountLeave(){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $("#interval_date").html(data.interval_date);
