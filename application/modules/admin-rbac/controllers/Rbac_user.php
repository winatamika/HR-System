...
class Rbac_user extends CI_Controller {
    ...
    public function index(){
        ...
        // $data['position'] = $this->global_model->general_combo_tree('m_position');
    ...
    function add_user(){
        ...
        $_POST['end_date'] = $this->global_model->texttodate($_POST['end_date']);
    ...
    function show_user(){
        ...
        $arr['end_date'] = $this->global_model->datetotext(@$data_user_detail->end_date);
