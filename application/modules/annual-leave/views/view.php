            ...
            <div class="box-header box-header-main" style="padding-bottom:0px;">
                <h3 class="box-title">
                    <div class="col-lg-12 no-padding">
                        <div class="form-input-date-filter" style="width: 290px; display: inline-block;">
                            <small id="countLeave" class="label label-success label-flat" style="display: inline-block; border-radius: 0px; margin-right: 9px; font-size: 14px; padding: 10px 15px; min-width: 90px;"></small>
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="col-lg-6" id="half_date_wrap">
                                    ...
                                    <div class="hide" id="xxxTemplate">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div class="form-group">
                                                    <input type="text" class="form-control text_half_date"/>
                                                </div>
                                            </div>
                                            <div class="col-lg-1">
                                                <div class="form-group">
                                    ...
                                    <div class="row" style="margin-bottom: 20px;">
                                        <div class="col-md-12 col-lg-12">
                                            <div class="btn-group btn-block">
                                                <button type="button" class="btn btn-flat btn-sm btn-block pull-left addButton" data-template="xxx"><i class="fa fa-fw fa-calendar-minus-o"></i> Half Day</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6" id="exclude_date_wrap">
                                    ...
                                    <div class="hide" id="xxx1Template">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div class="form-group">
                                                    <input type="text" class="form-control text_exclude_date"/>
                                                </div>
                                            </div>
                                            <div class="col-lg-1">
                                                <div class="form-group">
                                                    <button type="button" class="btn btn-flat btn-xs pull-left removeButton1" data-template="xxx1"><i class="fa fa-fw fa-times-circle"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-bottom: 20px;">
                                        <div class="col-md-12 col-lg-12">
                                            <div class="btn-group btn-block">
                                                <button type="button" class="btn btn-flat btn-sm btn-block pull-left addButton1" data-template="xxx1"><i class="fa fa-fw fa-calendar-times-o"></i> Exclude Day</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Days</label>
                                        <input type="text" class="form-control" id="total_date" name="total_date" readonly="" style="background: rgb(255, 255, 255) none repeat scroll 0% 0%;"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
